...
Read docs-fork/Development/fork-workflow.md and docs-fork/Development/audit.md before multi-step fork work. Preserve upstream layout, style and build transforms. Keep changes focused; do not apply neko-wide class or formatting migrations here. Record evidence and next actions in the audit. Do not introduce game-state rollback or accept runtime performance regressions for maintainability. Preserve cleanup and lifetime checks.
